...
athleteocr: libocr.so OCR_server/AthleteOCR.java
	javac -cp OCR_server:opencv-470.jar -d OCR_server/ OCR_server/ImageProcessing.java
	javac -cp OCR_server:opencv-470.jar -d OCR_server/ OCR_server/AthleteOCR.java
	java -cp OCR_server:opencv-470.jar -Djava.library.path=. OCR_server/AthleteOCR
