...
public class OutputProcessor
{
        ...
        throws IOException
    {
        BufferedWriter writer = new BufferedWriter(new FileWriter(filepath));
        writer.write(
            leftPad("Name", 20) + leftPad("School", 20) + leftPad("Grade", 5) + leftPad("Time", 10)
        ...
        for (DraggableLine d : finishTimes)
        {
            ...
            writer.write(
                leftPad(athlete.getName(), 20) + leftPad(athlete.getSchool(), 20)
                    ...
                    + leftPad(d.getTimestamp().toString(), 10)
    ...
    {
        System.out.print(
            leftPad("Name", 20) + leftPad("School", 20) + leftPad("Grade", 10) + leftPad("Time", 10)
        ...
        for (DraggableLine d : finishTimes)
        {
            ...
            System.out.print(
                leftPad(athlete.getName(), 20) + leftPad(athlete.getSchool(), 20)
                    + leftPad(Integer.toString(athlete.getGrade()), 10)
                    + leftPad(performance, 10)
                    + leftPad(athlete.getSeed().toString(), 10) + "\n");
        }
    }
}
