...
public class CameraStarter {
    ...
    /**
     * Blocks for 10 seconds while waiting for the sound threshold to be exceeded. If the threshold is not exceeded in
     * this interval, returns -1 and may lead to downstream errors.
