    ...
    implements Comparable
{
    ...
    public TimeFormat(String originalTime)
    {
        ...
        numberSeconds +=
            Double.parseDouble(originalTime.substring(firstColonIndex + 1, firstColonIndex + 3));
        double mils = Double.parseDouble(
            originalTime.substring(
                firstColonIndex + 4,
    ...
    /**
     * An objective way of looking at the time; represents the TimeFormat as a single int denoting the total milliseconds
